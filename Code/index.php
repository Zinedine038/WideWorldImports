<?php
session_start();
print("DANKJEWEL WWI JE WAS MOOI! RIP.");
print("NEVER FORGET WWI :(     PS. IK ZAL ERVOOR ZORGEN DAT SJOERD GEEN INDEXEN MEER VERMINKT, ZOVEEL BEN IK JE DAN NOG WEL SCHULDIG");
$count = 0;
$i = 0;
